      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
            Create Group
          </button>
        </div>
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12">
                    <div className="text-center">
                      ...
                      <p className="mt-1 text-sm text-gray-500">Create your first group to start collaborating.</p>
                      <button
                        onClick={() => setShowCreateModal(true)}
                        className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                      >
                        Create Group
                      </button>
                    </div>
